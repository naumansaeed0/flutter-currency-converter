...
@lazySingleton
class GetHistoricalRates implements UseCase<List<HistoricalRateEntity>, GetHistoryParams> {
  final CurrencyRepository repository;

  GetHistoricalRates(this.repository);

  @override
  Future<Either<Failure, List<HistoricalRateEntity>>> call(GetHistoryParams params) async {
